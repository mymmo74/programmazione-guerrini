...
function OggGriglia(nomePil, casaPil) {
    this.nomePil = nomePil;
    this.casaPil = casaPil;
    this.grigliaPart = 0;
    this.risFinale = 0;
    this.htmlbr = function () {
        let ris = this.nomePil + " " + this.casaPil + " " + this.grigliaPart + " " + this.risFinale + " <br/>";
        return ris;
    };
}
;
...
function aggPilota() {
    ...
    let griglia = new OggGriglia(txPilota, txCasa);

    arrGriglia.push(griglia);
